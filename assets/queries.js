...
export const project = groq`*[ _type == "project" && uid.current == $uid  && __i18n_lang == $lang][0]{
	$lang == 'ru' => {
       'langs': [
		    {
			   'id': __i18n_lang,
...
export const article = groq`*[ _type == "article" && uid.current == $uid  && __i18n_lang == $lang][0]{
	$lang == 'ru' => {
       'langs': [
		    {
			   'id': __i18n_lang,
...
export const service = groq`*[ _type == "service" && uid.current == $uid && __i18n_lang == $lang][0]{
	$lang == 'ru' => {
       'langs': [
		    {
			   'id': __i18n_lang,
